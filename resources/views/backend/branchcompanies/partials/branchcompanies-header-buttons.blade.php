<!--Action Button-->
@if( Active::checkUriPattern( 'admin/branchcompanies' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.branchcompanies.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.branchcompanies.all' ) }}
            </a>
        </li>
        @permission( 'create-branchcompany' )
            <li>
                <a href="{{ route( 'admin.branchcompanies.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.branchcompanies.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
