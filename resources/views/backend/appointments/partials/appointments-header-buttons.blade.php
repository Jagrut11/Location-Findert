<!--Action Button-->
@if( Active::checkUriPattern( 'admin/appointments' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.appointments.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.appointments.all' ) }}
            </a>
        </li>
        @permission( 'create-appointment' )
            <li>
                <a href="{{ route( 'admin.appointments.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.appointments.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
