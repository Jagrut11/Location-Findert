<!--Action Button-->
@if( Active::checkUriPattern( 'admin/seats' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.seats.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.seats.all' ) }}
            </a>
        </li>
        @permission( 'create-seat' )
            <li>
                <a href="{{ route( 'admin.seats.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.seats.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
