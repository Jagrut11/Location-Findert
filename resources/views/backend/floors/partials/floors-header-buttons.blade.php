<!--Action Button-->
@if( Active::checkUriPattern( 'admin/floors' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.floors.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.floors.all' ) }}
            </a>
        </li>
        @permission( 'create-floor' )
            <li>
                <a href="{{ route( 'admin.floors.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.floors.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
